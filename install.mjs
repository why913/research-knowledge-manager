...
const TARGETS = [
  ...
  { key: 'zcode',    name: 'ZCode',            dir: h('.zcode', 'skills'),                detect: h('.zcode') },
  { key: 'trae',     name: 'Trae',             dir: h('.trae', 'skills'),                 detect: h('.trae') },
  { key: 'trae-cn',  name: 'Trae CN',          dir: h('.trae-cn', 'skills'),              detect: h('.trae-cn') },
  { key: 'lingma',   name: 'Lingma',           dir: h('.lingma', 'skills'),               detect: h('.lingma') },
  { key: 'qoder',    name: 'Qoder',            dir: h('.qoder', 'skills'),                detect: h('.qoder') },
  { key: 'iflow',    name: 'iFlow CLI',        dir: h('.iflow', 'skills'),                detect: h('.iflow') },
